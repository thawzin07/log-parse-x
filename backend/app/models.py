...
class LogRecord(Base):
    ...
    raw_record: Mapped[dict] = mapped_column(JSONB, default=dict, nullable=False)
    normalized: Mapped[dict] = mapped_column(JSONB, default=dict, nullable=False)
    metrics: Mapped[dict] = mapped_column(JSONB, default=dict, nullable=False)
    unknown_fields: Mapped[dict] = mapped_column(JSONB, default=dict, nullable=False)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), server_default=func.now())
...
class SchemaProfile(Base):
    ...
    known_keys: Mapped[list[str]] = mapped_column(JSONB, default=list, nullable=False)
